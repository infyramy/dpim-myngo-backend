...
class ProductsController {
    ...
    static async getAllProducts(_req, res) {
        try {
            ...
            // Business fields
            "businesses.b_id as business_id", "businesses.b_company_name as business_name", "businesses.b_ssm_number as business_ssm", "businesses.b_office_number as business_phone", "businesses.b_address as business_address", "businesses.b_type as business_type", "businesses.b_sector as business_sector", "businesses.b_category as business_category", "businesses.b_mof_registration as business_mof_registration", "businesses.b_mof_registration_number as business_mof_registration_number", "businesses.b_url as business_url", "businesses.b_created_at as business_created_at")
            ...
            const formattedProducts = await Promise.all(products.map(async (product) => ({
                ...
                business: product.business_id
                    ? {
                        ...
                        type: await ProductsController.getLookupTitle("business_type", product.business_type),
                        sector: await ProductsController.getLookupTitle("business_sector", product.business_sector),
                        category: await ProductsController.getLookupTitle("business_category", product.business_category),
    ...
    static async getLookupTitle(lookupValue, lookupId) {
        ...
        if (lookupValue === "business_type")
            lookupGroupcode = 1;
        else if (lookupValue === "business_sector")
            lookupGroupcode = 6;
     ...
     */
    static async createOrGetTags(tagNames, userId) {
        const tags = [];
